...
void update_position(double *x, double *y, double *vx, double *vy, double *ax, double *ay, int n) {
...
void update_velocity(double *m, double *x, double *y, double *vx, double *vy, double *ax, double *ay, int n) {
...
void master() {
    ...
    for (int i = 0; i < n_iteration; i++){
        ...
        update_velocity(m, x, y, vx, vy, ax, ay, n_body);
        update_position(x, y, vx, vy, ax, ay, n_body);
